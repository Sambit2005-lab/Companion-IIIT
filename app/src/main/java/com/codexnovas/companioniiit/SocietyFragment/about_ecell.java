...
public class about_ecell extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_about_ecell, container, false);

        eventsRecyclerView = view.findViewById(R.id.our_events_recyclerview_ecell);
        teamMembersRecyclerView = view.findViewById(R.id.team_members_recyclerview_ecell);
        ...
        databaseReference.child("hosts").child("5").child("eventImages").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        databaseReference.child("hosts").child("5").child("teamMembers").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
