...
public class about_culturalsociety extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        eventsRecyclerView = view.findViewById(R.id.our_events_recyclerview_culturalsociety);
        teamMembersRecyclerView = view.findViewById(R.id.team_members_recyclerview_culturalsociety);
        ...
        databaseReference.child("hosts").child("4").child("eventImages").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        databaseReference.child("hosts").child("4").child("teamMembers").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
