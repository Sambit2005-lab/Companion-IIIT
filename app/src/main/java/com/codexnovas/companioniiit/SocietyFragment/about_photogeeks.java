...
public class about_photogeeks extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        eventsRecyclerView = view.findViewById(R.id.our_events_recyclerview_photogeeks);
        teamMembersRecyclerView = view.findViewById(R.id.team_members_recyclerview_photogeeks);
        ...
        databaseReference.child("hosts").child("10").child("eventImages").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        databaseReference.child("hosts").child("10").child("teamMembers").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
