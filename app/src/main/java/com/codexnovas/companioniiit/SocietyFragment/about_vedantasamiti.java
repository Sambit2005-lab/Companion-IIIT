...
public class about_vedantasamiti extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_about_vedantasamitisociety, container, false);

        eventsRecyclerView = view.findViewById(R.id.our_events_recyclerview_vedantasamiti);
        teamMembersRecyclerView = view.findViewById(R.id.team_members_recyclerview_vedantasamiti);
        ...
        databaseReference.child("hosts").child("12").child("eventImages").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        databaseReference.child("hosts").child("12").child("teamMembers").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
