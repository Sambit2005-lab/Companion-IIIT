...
public class about_paracosm extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_about_paracosmsociety, container, false);

        eventsRecyclerView = view.findViewById(R.id.our_events_recyclerview_paracosmsociety);
        teamMembersRecyclerView = view.findViewById(R.id.team_members_recyclerview_paracosmsociety);
        ...
        databaseReference.child("hosts").child("9").child("eventImages").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        databaseReference.child("hosts").child("9").child("teamMembers").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
