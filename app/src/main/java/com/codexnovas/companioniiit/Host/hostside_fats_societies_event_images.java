...
public class hostside_fats_societies_event_images extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hostside_fats_societies_event_images);
        ...
        if (hostEmail != null) {
            ...
            if (hostEmail.equals("fats@iiit-bh.ac.in")) {
                hostEventsRef = mDatabase.child("6").child("eventImages");
            } else {
                ...
                fileReference.putFile(imageUri)
                        ...
                        .addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText( hostside_fats_societies_event_images.this, "Failed to upload image: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        });
            }
        }
            ...
            hostEventsRef.child(imageId).setValue(imageUrl)
                    .addOnCompleteListener(task -> {
                        if (task.isSuccessful()) {
                            Toast.makeText( hostside_fats_societies_event_images.this, "Image uploaded successfully", Toast.LENGTH_SHORT).show();
                            finish(); // Close the activity
                        } else {
                            Toast.makeText( hostside_fats_societies_event_images.this, "Failed to save image URL", Toast.LENGTH_SHORT).show();
                        }
                    });
        }
    }
