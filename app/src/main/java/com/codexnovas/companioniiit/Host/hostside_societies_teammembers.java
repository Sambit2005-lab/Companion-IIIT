...
public class hostside_societies_teammembers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hostside_societies_teammembers);
        ...
        if (hostEmail != null) {
            ...
            if (hostEmail.equals("tech-society@iiit-bh.ac.in")) {
                hostMembersRef = mDatabase.child("2").child("teamMembers");
            } else {
            ...
            hostMembersRef.child(memberId).setValue(memberData)
                    .addOnCompleteListener(task -> {
                        if (task.isSuccessful()) {
                            Toast.makeText(hostside_societies_teammembers.this, "Member added successfully", Toast.LENGTH_SHORT).show();
                            finish(); // Close the activity
                        } else {
                            Toast.makeText(hostside_societies_teammembers.this, "Failed to add member", Toast.LENGTH_SHORT).show();
                        }
                    });
        }
    }
