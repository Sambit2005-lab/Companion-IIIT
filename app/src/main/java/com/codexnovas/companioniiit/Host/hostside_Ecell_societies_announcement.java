...
public class hostside_Ecell_societies_announcement extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hostside_ecell_societies_announcement);
                ...
                fileReference.putFile(imageUri)
                        ...
                        .addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                ...
                                Toast.makeText( hostside_Ecell_societies_announcement.this, "Failed: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        });
            } else {
    ...
    private void saveAnnouncementData(String imageUrl, String caption, String postedBy) {
        ...
        if (hostEmail.equals("ecell@iiit-bh.ac.in")) {
            hostAnnouncementsRef = databaseReference.child("5").child("announcements");
        } else {
        ...
        hostAnnouncementsRef.child(key).setValue(announcementData)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        progressDialog.dismiss();
                        Toast.makeText( hostside_Ecell_societies_announcement.this, "Announcement uploaded", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
