...
public class about_naps extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_about_naps, container, false);

        eventsRecyclerView = view.findViewById(R.id.our_events_recyclerview_naps);
        teamMembersRecyclerView = view.findViewById(R.id.team_members_recyclerview_naps);
        ...
        databaseReference.child("hosts").child("8").child("eventImages").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        databaseReference.child("hosts").child("8").child("teamMembers").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
