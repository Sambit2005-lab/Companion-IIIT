...
public class about_sports extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_about_sportssociety, container, false);
        ...
        databaseReference.child("hosts").child("11").child("eventImages").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        databaseReference.child("hosts").child("11").child("teamMembers").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
