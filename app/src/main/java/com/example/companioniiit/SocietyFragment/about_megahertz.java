...
public class about_megahertz extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_about_megahertzsociety, container, false);

        eventsRecyclerView = view.findViewById(R.id.our_events_recyclerview_megahertzsociety);
        teamMembersRecyclerView = view.findViewById(R.id.team_members_recyclerview_megahertzsociety);
        ...
        databaseReference.child("hosts").child("7").child("eventImages").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        databaseReference.child("hosts").child("7").child("teamMembers").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
