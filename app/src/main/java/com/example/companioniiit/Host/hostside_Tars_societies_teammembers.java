...
public class hostside_Tars_societies_teammembers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hostside_tars_societies_teammembers);
            ...
            fileReference.putFile(imageUri)
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(hostside_Tars_societies_teammembers.this, "Failed to upload image: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
        }
    }
            ...
            hostMembersRef.child(memberId).setValue(memberData)
                    .addOnCompleteListener(task -> {
                        if (task.isSuccessful()) {
                            Toast.makeText(hostside_Tars_societies_teammembers.this, "Member added successfully", Toast.LENGTH_SHORT).show();
                            finish(); // Close the activity
                        } else {
                            Toast.makeText(hostside_Tars_societies_teammembers.this, "Failed to add member", Toast.LENGTH_SHORT).show();
                        }
                    });
        }
    }
