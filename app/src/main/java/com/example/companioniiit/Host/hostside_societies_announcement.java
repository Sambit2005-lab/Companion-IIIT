...
public class hostside_societies_announcement extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hostside_societies_announcement);
    ...
    private void saveAnnouncementData(String imageUrl, String caption, String postedBy) {
        ...
        if (hostEmail.equals("tech-society@iiit-bh.ac.in")) {
            hostAnnouncementsRef = databaseReference.child("2").child("announcements");
        } else {
        ...
        hostAnnouncementsRef.child(key).setValue(announcementData)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        progressDialog.dismiss();
                        Toast.makeText(hostside_societies_announcement.this, "Announcement uploaded", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
