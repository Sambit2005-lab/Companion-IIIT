...
public class hostside_Culturalsocieties_teammembers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hostside_culturalsocieties_teammembers);
        ...
        if (hostEmail != null) {
            ...
            if (hostEmail.equals("hostculturalsociety@gmail.com")) {
                hostMembersRef = mDatabase.child("4").child("teamMembers");
            } else {
