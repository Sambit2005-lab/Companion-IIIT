...
public class ecell_host_home extends AppCompatActivity {
    ...
    private String hostEmail = "ecell@iiit-bh.ac.in"; // Hardcoded host email
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ecell_host_home);
        ...
        if (hostEmail.equals("ecell@iiit-bh.ac.in")) {
            hostJoiningLinksRef = databaseReference.child("5").child("joining_links");
        } else {
            ...
            hostJoiningLinksRef.child(linkId).setValue(joiningLink)
                    .addOnCompleteListener(task -> {
                        if (task.isSuccessful()) {
                            Toast.makeText(ecell_host_home.this, "Joining link saved successfully", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(ecell_host_home.this, "Failed to save joining link", Toast.LENGTH_SHORT).show();
                        }
                    });
        }
    }
    ...
    private void OnclickAddannouncementbtn() {
        Addannouncementbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ecell_host_home.this, hostside_Ecell_societies_announcement.class);
    ...
    private void OnclickAddEventimgbtn() {
        AddEventimgbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ecell_host_home.this, hostside_Ecell_societies_event_images.class);
    ...
    private void OnclickAddTeamMemberbtn() {
        AddTeamMemberbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ecell_host_home.this, hostside_Ecell_societies_teammembers.class);
                intent.putExtra("hostEmail", hostEmail);
                startActivity(intent);
            }
        });
    ...
    private void OnclickAddEventbtn() {
        AddEventbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ecell_host_home.this, hostside_Ecell_societies_calendar.class);
                intent.putExtra("hostEmail", hostEmail);
                startActivity(intent);
            }
        });
