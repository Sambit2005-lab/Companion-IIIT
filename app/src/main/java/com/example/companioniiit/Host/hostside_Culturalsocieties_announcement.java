...
public class hostside_Culturalsocieties_announcement extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hostside_culturalsocieties_announcement);
            ...
            fileReference.putFile(imageUri)
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            Toast.makeText(hostside_Culturalsocieties_announcement.this, "Failed: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
        } else {
        ...
        hostAnnouncementsRef.child(key).setValue(announcementData)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        progressDialog.dismiss();
                        Toast.makeText(hostside_Culturalsocieties_announcement.this, "Announcement uploaded", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
